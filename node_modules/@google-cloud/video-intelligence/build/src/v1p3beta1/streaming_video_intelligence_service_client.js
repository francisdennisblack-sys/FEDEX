...
exports.StreamingVideoIntelligenceServiceClient = void 0;
...
class StreamingVideoIntelligenceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.videointelligence.v1p3beta1.StreamingVideoIntelligenceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.streamingVideoIntelligenceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.videointelligence.v1p3beta1.StreamingVideoIntelligenceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.videointelligence.v1p3beta1.StreamingVideoIntelligenceService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const streamingVideoIntelligenceServiceStubMethods = ['streamingAnnotateVideo'];
        for (const methodName of streamingVideoIntelligenceServiceStubMethods) {
            const callPromise = this.streamingVideoIntelligenceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
