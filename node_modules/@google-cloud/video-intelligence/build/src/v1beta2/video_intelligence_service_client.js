...
class VideoIntelligenceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const annotateVideoResponse = protoFilesRoot.lookup('.google.cloud.videointelligence.v1beta2.AnnotateVideoResponse');
        const annotateVideoMetadata = protoFilesRoot.lookup('.google.cloud.videointelligence.v1beta2.AnnotateVideoProgress');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.videointelligence.v1beta2.VideoIntelligenceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.videoIntelligenceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.videointelligence.v1beta2.VideoIntelligenceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.videointelligence.v1beta2.VideoIntelligenceService, this._opts, this._providedCustomServicePath);
